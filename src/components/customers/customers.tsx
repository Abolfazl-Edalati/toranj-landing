...
export default function Customers() {
  ...
  const columns = Math.min(customers.length, 4);
  ...
  return (
    <div className="flex flex-col gap-16 mb-32 max-[970px]:mb-20 max-[880px]:gap-10 max-[620px]:mb-16 max-[550px]:gap-6">
      ...
      <div
        className={`grid grid-cols-${columns} gap-y-24 overflow-auto px-28 max-[1250px]:grid-cols-3 max-[980px]:px-0 max-[680px]:grid-cols-2`}
